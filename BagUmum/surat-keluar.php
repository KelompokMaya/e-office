        ...
        <div id="tabelSuratKeluar" class=" col-xs-12" >
          <div class="box box-danger">
              ...
              <?php
                ...
                $sql = mysqli_query($koneksi, "SELECT * FROM tb_suratkeluar a,tb_jenis_surat b WHERE a.Id_jenis_surat=b.Id_jenis_surat ORDER BY No_urut_surat DESC;");
                 $no = 1;
              ...
              <form id="form_tambahPengguna" class="form-horizontal" action="surat-keluar.php?tambahSuratKeluar" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <div class="control-label" style="text-align:left;">
                        ...
                        <?php          
                      $sql = mysqli_query($koneksi, "SELECT * FROM tb_jenis_surat  WHERE surat='surat keluar' ");
                       $no = 1;
                        while($row = mysqli_fetch_assoc($sql)){
