    ...
    if(isset($_POST['editdisposisi']))
          {
            ...
            $disposisi_isi                   = $_POST['disposisi-isi'];
               ...
               $update = mysqli_query($koneksi, " UPDATE tb_disposisi set Disposisi='$disposisi_isi',Kode_bagian='$disposisi_Tujuan',Status_disposisi='terima kepala dinas' WHERE Nomor_surat_masuk='$disposisi_Nomor_surat_masuk' ") or die(mysqli_error($koneksi));
      ...
      if(isset($_GET["kirim"]))
        {
               ...
               $update = mysqli_query($koneksi, " UPDATE tb_disposisi set Status_disposisi='terkirim Sub Bagian Umum' WHERE No_urut_disposisi='$id_disposisi' ") or die(mysqli_error($koneksi));
              ...
              $judul= $row['Perihal'];
               ...
               $insert = mysqli_query($koneksi, "INSERT INTO tb_notif( asal_hak_akses,tujuan_hak_akses,judul,id_disposisi,status) VALUES('$hak_akses','Sub Bagian Umum','$judul','$id_disposisi','terkirim')") or die(mysqli_error($koneksi));
