                    ...
                    if ($row['Status_disposisi']!='belum terkirim' && $row['Status_disposisi']!='terkirim sekretaris') { ?>
                       <tr>
                                  ...
                                  <?php if ($row['Status_disposisi']=='terima sekretaris') { ?>
                                     <a href="surat-masuk.php?kirim&&id=<?php echo $row['No_urut_disposisi'];?>"  class="btn btn-success btn-flat" data-toggle="tooltip" title="Kirim Disposisi" ><i class="fa fa-paper-plane"></i></a>
